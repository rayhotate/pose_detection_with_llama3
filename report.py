...
def generate_report():
    ...
    with open('README.md', 'w') as f:
        ...
        f.write("```mermaid\n")
        f.write("graph TD\n")
        f.write("    A[Input Image] --> B[Load Image]\n")
        f.write("    B --> C[Describe Image]\n") 
        f.write("    C --> D[Generate Initial Analysis]\n")
        f.write("    D --> E[Detailed Prompt Analysis]\n")
        f.write("    E --> F[Generate Full Response]\n")
        f.write("    F --> G[Determine Turning Assistance]\n")
        f.write("    G --> H[Binary Classification]\n")
        f.write("    H --> I[Reasoning Output]\n")
        f.write("\n")
        f.write("    %% Process Description:\n")
        f.write("    %% A->B: Load the image from the specified path\n")
        f.write("    %% B->C: Generate an initial description of the image\n")
        f.write("    %% C->D: Create a preliminary analysis based on the description\n")
        f.write("    %% D->E: Apply a detailed prompt for further analysis\n")
        f.write("    %% E->F: Generate a comprehensive response\n")
        f.write("    %% F->G: Evaluate if turning assistance is occurring\n")
        f.write("    %% G->H: Classify the scenario as True or False\n")
        f.write("    %% H->I: Output the reasoning behind the classification\n")
        f.write("```\n\n")
